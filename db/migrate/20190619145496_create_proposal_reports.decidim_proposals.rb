...
class CreateProposalReports < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :decidim_proposals_proposal_reports, %i[decidim_proposal_id decidim_user_id], unique: true, name: 'decidim_proposals_proposal_report_proposal_user_unique'
  end
end
